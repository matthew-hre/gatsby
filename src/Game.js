...
class Game extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            questions: [
                [
                    [<h3>In F. Scott Fitzgerald's book <i>The Great Gatsby</i>, Daisy says...</h3>],
                ...
                [
                    [<h3>"'They're such beautiful shirts,' she sobbed, her voice muffled in the thick folds. 'It makes me sad because I've never seen such-such beautiful shirts before.'” represents Daisy's symbol of...</h3>],
                    ["Her heart", 1],
                    ["Her voice", 0],
                    ["Her dress", 0],
                ],
                [
                    [<h3>In F. Scott Fitzgerald's book <i>The Great Gatsby</i>, this quote reveals a symbol of Daisy.</h3>],
                ...
                [
                    [<h3>"That was the inexhaustible charm that rose and fell in it, the jingle of it, the cymbals' song of it.” represents Daisy's symbol of...</h3>],
                    ["Her heart", 0],
                    ["Her voice", 1],
                    ["Her dress", 0],
                ],
                [
                    [<h3>In F. Scott Fitzgerald's book <i>The Great Gatsby</i>, this quotes introduces a symbol of Daisy.</h3>],
                ...
                [
                    [<h3>"They were both in white and their dresses were rippling and fluttering.” represents Daisy's symbol of...</h3>],
                    ["Her heart", 0],
                    ["Her voice", 0],
                    ["Her dress", 1],
                ]
